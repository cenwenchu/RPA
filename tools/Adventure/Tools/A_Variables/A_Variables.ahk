...
Global A := Array()
     ...
     , Indent := (NT6) ? "    " : ""
     , Icon := A_ScriptDir . "\..\..\Icons\A_Variables.ico"
...
Gui Add, Picture, x10 y10 w32 h32, % A_IsCompiled ? A_ScriptName : Icon
...
; Footer area
Gui Add, TreeView, hWndhTV x-1 y386 w690 h48 BackgroundF1F5FB Disabled ; Background
Gui Font, s9, Segoe UI
Gui Add, Edit, hWndhEdtSearch vSearch gSearch x10 y398 w186 h23 +0x2000000 ; WS_CLIPCHILDREN
; Hint text
DllCall("SendMessage", "Ptr", hEdtSearch, "UInt", 0x1501, "Ptr", 1, "WStr", "Search", "Ptr")
; Search icon
If (FileExist(SearchIcon := A_ScriptDir . "\..\..\Icons\Search.ico")) {
    Gui Add, Picture, hWndhPicSearch x165 y1 w16 h16, %SearchIcon%
...
Menu ContextMenu, Icon, 1&, shell32.dll, -243
