...
, g_AutoGUI
, g_AutoGUIPath := A_ScriptDir . "\..\..\Adventure.ahk"
, g_StrRequireAdmin
, g_StrRequireVista
, g_StrRequire32bit
, g_StrRequire64bit
...
SetMainIcon(A_ScriptDir . "\..\..\Icons\AhkDirectives.ico")
...
Gui Show, w349 h481, AutoHotkey Script Directives
...
g_AutoGUI := InStr(DllCall("GetCommandLine", "Str"), " /A")
